        ...
        if wind_on:
            ...
            if wmag > 1e-3:
                ...
                if not wind_in_corner:
                    # Original behavior: arrow length depends on wind magnitude
                    arrow_len = 0.2 * wmag  # scaled by 0.2 for display
...
class DroneWithBorderGradient:
    def __init__(self):
        ...
        # store wind/grad states at "S" time
        ...
        # For our time stepping
        self.last_time=time.time()

        # Toggle for displaying wind arrow in a corner vs. on the drone
        self.wind_display_in_corner = False  # default: arrow on drone
    ...
    def loop_once(self):
        ...
        for k in keyups:
            if k== ord('q'):
                ...
                # Toggle whether the wind arrow is drawn in a corner or on the drone
